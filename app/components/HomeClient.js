  ...
  if (showCalendar) {
    ...
    return (
      <div style={{ maxWidth: 480, margin: '0 auto', background: '#F9FAFB', minHeight: '100vh', fontFamily: "Inter, -apple-system, sans-serif", color: '#1F2937', paddingBottom: 140 }}>
        ...
        {/* Bottom nav */}
        <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(10px)', borderTop: '1px solid #F3F4F6', display: 'flex', padding: '4px 0 8px', zIndex: 300 }}>
          {[
    ...
    <div style={{ maxWidth: 600, margin: '0 auto', paddingBottom: 100, fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ marginTop: 40, padding: '0 20px 32px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 16, flexWrap: 'wrap', marginBottom: 12 }}>
          {[['Nurseries','/nurseries'],['Childcare cost calculator','/childcare-cost-calculator'],['For providers','/for-providers'],['Privacy Policy','/privacy'],['Cookie Policy','/cookies'],['Terms of Service','/terms'],['Contact','mailto:hello@littlelocals.uk']].map(([label, href]) => (
