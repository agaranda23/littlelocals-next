    ...
    <div style={{ maxWidth: 600, margin: '0 auto', paddingBottom: 100, fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ padding: '16px 16px 0' }}>
        ...
        {(() => {
          ...
          if (days <= 7) return <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: '#F0FDF4', border: '1px solid #BBF7D0', borderRadius: 20, padding: '6px 14px', marginBottom: 12, fontSize: 13, fontWeight: 700, color: '#15803D' }}>🆕 New this week</div>
